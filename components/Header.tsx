  ...
  return (
    <header className="fixed top-4 left-0 right-0 z-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-lg">
        <nav className="bg-white/70 dark:bg-zinc-800/80 backdrop-blur-xl rounded-2xl shadow-lg shadow-slate-300/50 dark:shadow-black/20 border border-black/5 dark:border-white/5">
          <div className="flex items-center justify-center h-16 px-4 sm:px-6">
            <a href="/" className="text-xl font-bold text-slate-900 dark:text-zinc-50 flex items-center gap-2">
