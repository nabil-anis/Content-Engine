    ...
    <main className="flex-grow flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight">
            Instantly Generate <span className="text-blue-600 dark:text-blue-500">SEO-Optimized</span> Blog Posts
          </h1>
          ...
          <div className="mt-10">
            <button
              onClick={onStart}
              className="bg-blue-600 text-white font-semibold py-3.5 px-8 rounded-lg hover:bg-blue-700 transition-all duration-300 flex items-center justify-center mx-auto transform hover:-translate-y-1"
            >
